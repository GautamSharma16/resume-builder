...
<div
    ...
    data-improve-url="{{ route('resume.improve') }}"
    data-grammar-url="{{ route('resume.grammar') }}"
    data-save-url="{{ route('resume.save') }}"
    data-download-url="{{ route('resume.download-improved') }}"
    data-payment-order-url="{{ route('resume.payment.order') }}"
    data-payment-verify-url="{{ route('resume.payment.verify') }}"
    data-razorpay-key="{{ $razorpayKey }}"
    data-download-amount="{{ $downloadAmount }}"
    data-download-currency="{{ $downloadCurrency }}"
>
    <div class="mb-8">
...
@vite('resources/js/improve-cv.js')
@endsection
