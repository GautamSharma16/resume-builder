...
<div class="bg-[#f7f9fe] overflow-hidden">
   ...
   <div class="relative overflow-hidden bg-white">
    ...
    {{-- Feature: Precision Layouts Section --}}
    <div class="py-24">
    ...
    {{-- Feature: AI Content Architect Section (with decorative elements) --}}
        ...
        <div class="hero-gradient py-20">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <div class="flex flex-wrap gap-4 justify-center">
                    <a href="{{ url('/templates') }}" class="bg-white text-[#254fd1] font-semibold px-8 py-3.5 rounded-xl transition-all hover:shadow-lg hover:scale-105 inline-flex items-center gap-2">
                        Create My Resume
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                        </svg>
                    </a>
                    <a href="{{ url('/templates') }}" class="border-2 border-white text-white font-semibold px-8 py-3.5 rounded-xl transition-all hover:bg-white/10">
                        View Templates
                    </a>
                </div>
            </div>
