...
<style>
    ...
    .orb-1 { width: 500px; height: 500px; background: rgba(37, 99, 235, 0.14); top: -100px; right: -100px; }
...
<script>
    ...
    window.addEventListener('scroll', updateTermsToc);
    legalScrollRoot?.addEventListener('scroll', updateTermsToc);
</script>
