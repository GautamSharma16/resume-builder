    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="{{ route('improve-cv') }}" class="text-gray-700 hover:text-blue-600 transition">Improve CV</a>
                <a href="{{ route('interview') }}" class="text-gray-700 hover:text-blue-600 transition">Interview</a>
