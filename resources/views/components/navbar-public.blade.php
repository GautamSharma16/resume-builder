...
<nav x-data="{ open: false, scrolled: false }"
    ...
    <div class="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10 xl:px-16">
        <div class="flex min-h-[82px] items-center justify-between gap-4 lg:gap-8">
            ...
            <div class="hidden min-w-0 flex-1 items-center justify-center gap-1 lg:flex xl:gap-2">
                <a href="{{ route('resume-maker') }}"
                   class="group relative whitespace-nowrap rounded-full px-3.5 py-2.5 text-[15px] font-semibold leading-none tracking-[0.01em] transition duration-200 xl:px-4 xl:text-base {{ request()->routeIs('resume-maker') ? 'bg-blue-50 text-blue-700 shadow-sm' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }}">
                    Resume Maker
                ...
                <a href="{{ route('templates') }}"
                   class="group relative whitespace-nowrap rounded-full px-3.5 py-2.5 text-[15px] font-semibold leading-none tracking-[0.01em] transition duration-200 xl:px-4 xl:text-base {{ request()->routeIs('templates') ? 'bg-blue-50 text-blue-700 shadow-sm' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }}">
                    Templates
                ...
                <a href="{{ route('cover-letter') }}"
                   class="group relative whitespace-nowrap rounded-full px-3.5 py-2.5 text-[15px] font-semibold leading-none tracking-[0.01em] transition duration-200 xl:px-4 xl:text-base {{ request()->routeIs('cover-letter') ? 'bg-blue-50 text-blue-700 shadow-sm' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }}">
                    Cover Letter
                ...
                <a href="{{ route('contact') }}"
                   class="group relative whitespace-nowrap rounded-full px-3.5 py-2.5 text-[15px] font-semibold leading-none tracking-[0.01em] transition duration-200 xl:px-4 xl:text-base {{ request()->routeIs('contact') ? 'bg-blue-50 text-blue-700 shadow-sm' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }}">
                    Contact Us
            ...
            <div class="hidden shrink-0 items-center lg:flex">
                <a href="{{ route('login') }}"
                   class="inline-flex min-h-12 items-center justify-center gap-2 rounded-[14px] bg-gradient-to-r from-blue-600 to-indigo-600 px-6 text-base font-bold text-white shadow-[0_14px_30px_rgba(37,99,235,0.24)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_18px_38px_rgba(37,99,235,0.32)] focus:outline-none focus:ring-4 focus:ring-blue-200 active:translate-y-0">
        ...
        <div x-show="open"
             ...
             class="lg:hidden">
            <div class="mb-4 rounded-[22px] border border-slate-200 bg-white p-2 shadow-[0_18px_45px_rgba(15,23,42,0.10)]">
                <a href="{{ route('resume-maker') }}" class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-base font-semibold {{ request()->routeIs('resume-maker') ? 'bg-blue-50 text-blue-700' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }} transition duration-200">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Resume Maker
                </a>
                <a href="{{ route('enhance-cv') }}" class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-base font-semibold {{ request()->routeIs('enhance-cv') || request()->routeIs('improve-cv') ? 'bg-blue-50 text-blue-700' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }} transition duration-200">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    </svg>
                    Enhance CV
                </a>
                <a href="{{ route('templates') }}" class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-base font-semibold {{ request()->routeIs('templates') ? 'bg-blue-50 text-blue-700' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }} transition duration-200">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/>
                    </svg>
                    Templates
                </a>
                <a href="{{ route('cover-letter') }}" class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-base font-semibold {{ request()->routeIs('cover-letter') ? 'bg-blue-50 text-blue-700' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }} transition duration-200">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('contact') }}" class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-base font-semibold {{ request()->routeIs('contact') ? 'bg-blue-50 text-blue-700' : 'text-slate-700 hover:bg-slate-50 hover:text-blue-700' }} transition duration-200">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    Contact Us
                ...
                <div class="mt-2 border-t border-slate-100 pt-2">
                    <a href="{{ route('login') }}"
                       class="flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-3.5 text-base font-bold text-white shadow-[0_14px_30px_rgba(37,99,235,0.22)] transition duration-200 hover:-translate-y-0.5">
