...
<div class="p-6 lg:p-8">
    <a href="{{ route('admin.leads.index') }}" class="text-sm font-semibold text-blue-600">Back to general enquiries</a>
    <div class="mt-5 max-w-3xl rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <dl class="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2"><dt class="text-xs font-bold uppercase tracking-wider text-slate-400">Subject</dt><dd class="mt-1 text-slate-900">{{ $lead->subject ?: 'General enquiry' }}</dd></div>
