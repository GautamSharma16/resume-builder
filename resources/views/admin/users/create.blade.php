...
<div class="p-6">
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-sm text-gray-500">Create a new administrative account</p>
        </div>

        <form action="{{ route('admin.users.store') }}" method="POST" class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-6">
            @csrf
            ...
            <div id="permissions-container" class="pt-4 border-t border-gray-100 {{ old('role') === 'admin' ? 'hidden' : '' }}">
