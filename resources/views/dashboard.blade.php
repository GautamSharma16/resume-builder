<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <a href="{{ route('resume.create') }}" class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg shadow-lg hover:shadow-xl transition overflow-hidden group cursor-pointer">
                <div class="p-8">
            ...
            <a href="{{ route('templates') }}" class="bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg shadow-lg hover:shadow-xl transition overflow-hidden group cursor-pointer">
                <div class="p-8">
                    <div class="w-16 h-16 bg-white bg-opacity-20 rounded-lg flex items-center justify-center mb-4 group-hover:bg-opacity-30 transition">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-6">
                <div class="text-center py-12">
                    ...
                    <p class="mt-4 text-gray-600">No resumes yet. <a href="{{ route('resume.create') }}" class="text-blue-600 font-medium hover:text-blue-700">Create your first one</a></p>
                </div>
            </div>
        </div>
    </div>
