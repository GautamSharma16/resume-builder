                            ...
                            <div class="doc-preview-wrap">
                                ...
                                <div class="doc-overlay">
                                    <div class="overlay-actions">
                                        ...
                                        <form method="POST" action="{{ route('resume.destroy', $resume) }}" data-delete-confirm data-confirm-title="Delete Resume" data-confirm-message="Are you sure you want to delete this resume? This action cannot be undone." class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="overlay-btn text-red-600 hover:!bg-red-600 hover:!text-white" title="Delete">
                            ...
                            <div class="doc-preview-wrap">
                                ...
                                <div class="doc-overlay">
                                    <div class="overlay-actions">
                                        ...
                                        <form method="POST" action="{{ route('cover-letter.destroy', $letter) }}" data-delete-confirm data-confirm-title="Delete Cover Letter" data-confirm-message="Are you sure you want to delete this cover letter? This action cannot be undone." class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="overlay-btn text-red-600 hover:!bg-red-600 hover:!text-white" title="Delete">
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
