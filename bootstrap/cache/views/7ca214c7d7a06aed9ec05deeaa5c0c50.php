...
<div id="create-cv-app" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-store-url="<?php echo e(route('resume.store')); ?>">
    <div class="mb-6">
            ...
            <div>
                ...
                <select id="template-id" class="w-full rounded-md border-gray-300 text-sm">
                    ...
                    <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($template->id); ?>" <?php if($selectedTemplate === $template->slug): echo 'selected'; endif; ?>><?php echo e($template->name); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resume-builder\resume-builder\resources\views/resume/create.blade.php ENDPATH**/ ?>