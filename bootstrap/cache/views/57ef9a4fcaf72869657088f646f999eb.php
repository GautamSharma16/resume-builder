...
<div id="cover-letter-app" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-generate-url="<?php echo e(route('cover-letter.generate')); ?>">
    <div class="mb-6">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resume-builder\resume-builder\resources\views\pages\cover-letter.blade.php ENDPATH**/ ?>