...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="bg-white border border-gray-200 rounded-lg p-6 sm:p-8 shadow-sm">
        ...
        <form method="POST" action="<?php echo e(route('register.store')); ?>" class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <?php echo csrf_field(); ?>
            <div class="md:col-span-2">
                <label class="block text-sm font-semibold text-gray-800 mb-1">Name</label>
                <input name="name" value="<?php echo e(old('name')); ?>" required class="w-full rounded-md border-gray-300 text-sm focus:border-teal-600 focus:ring-teal-600">
            </div>
            <div>
            ...
            <div>
                ...
                <input name="mobile" value="<?php echo e(old('mobile')); ?>" required class="w-full rounded-md border-gray-300 text-sm focus:border-teal-600 focus:ring-teal-600">
            </div>
            <div>
        ...
        <p class="mt-5 text-sm text-gray-600">Already registered? <a href="<?php echo e(route('login')); ?>" class="font-semibold text-teal-700">Login</a></p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resume-builder\resume-builder\resources\views/auth/register.blade.php ENDPATH**/ ?>