...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ── MAIN GRID ── */
    .contact-main { display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: start; margin-bottom: 80px; }
    ...
    .form-card {
        ...
        box-shadow: 0 2px 0 rgba(37,99,235,0.04), 0 12px 40px rgba(0,0,0,0.06);
        transition: transform 0.35s var(--ease-spring), box-shadow 0.35s ease;
        animation: fadeUp 0.7s var(--ease-out) 0.3s both;
    }
    .form-card:hover { transform: translateY(-4px); box-shadow: 0 2px 0 rgba(37,99,235,0.06), 0 24px 56px rgba(0,0,0,0.1); }
    ...
    .success-msg {
        ...
        color: #065f46; font-size: 0.84rem; font-weight: 600; text-align: center;
    }
    ...
    .form-field input,
    .form-field textarea {
        width: 100%; border: 1.5px solid rgba(0,0,0,0.08); border-radius: 14px;
        padding: 14px 18px; font-family: var(--font-body); font-size: 0.9rem;
        color: var(--ink); background: rgba(248,250,252,0.8); outline: none;
    ...
    .submit-btn {
        width: 100%; border: none; border-radius: var(--r-full); padding: 16px 24px;
        font-family: var(--font-body); font-size: 0.95rem; font-weight: 700;
        color: #fff; cursor: pointer; transition: all 0.3s var(--ease-spring);
    ...
    .submit-btn:hover { transform: translateY(-3px); box-shadow: 0 12px 32px rgba(37,99,235,0.45); }
    .submit-btn svg { width: 18px; height: 18px; stroke: #fff; fill: none; stroke-width: 2.2; }

    /* ── RIGHT SIDE ── */
    .right-content { display: flex; flex-direction: column; gap: 24px; animation: fadeUp 0.7s var(--ease-out) 0.35s both; }

    .image-card {
        border-radius: 28px; overflow: hidden;
        border: 1px solid rgba(37,99,235,0.12);
        background: linear-gradient(140deg, #eef4ff, #e8f0fe);
        transition: all 0.4s var(--ease-spring);
    }
    .image-card:hover { transform: translateY(-6px); box-shadow: 0 16px 40px rgba(37,99,235,0.1); }
    .image-card img { width: 100%; height: auto; display: block; animation: floatY 5s ease-in-out infinite; }
    .image-caption {
        padding: 20px 24px; background: rgba(255,255,255,0.8);
        border-top: 1px solid rgba(37,99,235,0.1); text-align: center;
    }
    .image-caption h4 { font-family: var(--font-display); font-size: 1.1rem; font-weight: 500; color: var(--navy); margin-bottom: 6px; }
    .image-caption p { font-size: 0.78rem; color: var(--muted); }
    ...
    .info-card:hover { transform: translateY(-3px); border-color: rgba(37,99,235,0.2); box-shadow: 0 10px 24px rgba(0,0,0,0.06); }
    .info-icon { width: 48px; height: 48px; border-radius: 16px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; background: rgba(37,99,235,0.1); }
    .info-icon svg { width: 22px; height: 22px; stroke: var(--blue); fill: none; stroke-width: 1.8; }
    .info-content h4 { font-size: 0.9rem; font-weight: 700; color: var(--navy); margin-bottom: 4px; }
    .info-content p { font-size: 0.7rem; color: var(--muted); margin-bottom: 4px; }
    .info-content a, .info-content strong { font-size: 0.8rem; font-weight: 600; color: var(--blue); text-decoration: none; }

    /* ── FAQ SECTION ── */
    .faq-section {
        margin-top: 40px; padding-top: 60px;
    ...
    .faq-item:hover { transform: translateY(-4px); border-color: rgba(37,99,235,0.2); box-shadow: 0 12px 28px rgba(0,0,0,0.06); }
    .faq-question {
        display: flex; justify-content: space-between; align-items: center;
        font-weight: 700; font-size: 1rem; color: var(--navy);
    }
    .faq-question svg { width: 20px; height: 20px; stroke: var(--blue); transition: transform 0.3s; }
    .faq-item.open .faq-question svg { transform: rotate(180deg); }
    .faq-answer {
        max-height: 0; overflow: hidden; transition: max-height 0.4s ease;
        font-size: 0.85rem; color: var(--muted); line-height: 1.6; margin-top: 0;
    }
    ...
    @media (max-width: 768px) {
        .contact-main { grid-template-columns: 1fr; gap: 36px; margin-bottom: 50px; }
